...
function approveModule() {
    safeSwalConfirm({
        ...
        text: `Approve "${currentModuleName}"? This module will be ready for posting.`,
...
function approveExam() {
    safeSwalConfirm({
        ...
        text: `Approve "${currentExamName}"? This examination will be ready for posting.`,
        confirmButtonText: 'Approve'
    }).then((confirmed) => {
        if (confirmed) {
...
function updateModuleStatus(moduleId, newStatus, successMessage, remarks = '') {
    ...
    .then(data => {
        if (data.success) {
            ...
            safeSwalFire({
                title: 'Error',
                text: 'Error updating module: ' + (data.message || 'Unknown error'),
                icon: 'error',
                confirmButtonText: 'OK'
            });
        }
    ...
    .catch(error => {
        ...
        safeSwalFire({
            title: 'Error',
            text: 'Error updating module status. Please try again.',
            icon: 'error',
            confirmButtonText: 'OK'
        });
    });
...
function updateExamStatus(examId, newStatus, successMessage, remarks = '') {
    ...
    .then(data => {
        if (data.success) {
            ...
            safeSwalFire({
                title: 'Error',
                text: 'Error updating examination: ' + (data.message || 'Unknown error'),
                icon: 'error',
                confirmButtonText: 'OK'
            });
        }
    ...
    .catch(error => {
        ...
        safeSwalFire({
            title: 'Error',
            text: 'Error updating examination status. Please try again.',
            icon: 'error',
            confirmButtonText: 'OK'
        });
    });
...
function safeSwalConfirm(options) {
    if (isSwalAvailable()) {
        return Swal.fire({
            icon: 'question',
