    ...
    <div id="termsModal" class="modal">
        <div class="modal-box max-w-4xl bg-white">
            <div class="flex justify-between items-center mb-4">
                ...
                <button class="btn btn-sm btn-circle" onclick="closeTermsModal()">âœ•</button>
            </div>
    ...
    <div id="myComplaintsModal" class="modal">
        <div class="modal-box max-w-5xl bg-white modal-scrollable">
            <div class="flex justify-between items-center mb-4">
                ...
                <button class="btn btn-sm btn-circle" onclick="closeMyComplaintsModal()">âœ•</button>
            </div>
    ...
    <div id="complaintDetailsModal" class="modal">
        <div class="modal-box max-w-4xl bg-white">
            <div class="flex justify-between items-center mb-4">
                ...
                <button class="btn btn-sm btn-circle" onclick="closeComplaintDetails()">âœ•</button>
            </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between">
                        <div class="flex-1">
                            ...
                            <div class="text-xs text-secondary">
                                ${complaint.location} â€¢ ${formatDate(complaint.date)}
                            </div>
                        </div>
