    ...
    <div class="flex flex-col flex-1 overflow-auto content-area">
      ...
      <main class="container mx-auto px-4 py-8">
        ...
        <div class="mb-6 header-actions">
          <button onclick="window.location.href = 'review_dashboard.php';" class="btn btn-ghost btn-sm">
      ...
      function generatePreviewContent() {
        ...
        previewHTML += `
          ...
          <div class="text-center mt-8 pt-6 border-t border-gray-200">
            <button type="button" class="btn btn-primary btn-wide" onclick="alert('This would submit the exam in a real application')">
      ...
      createExamBtn.addEventListener('click', function(e) {
          ...
          questions.forEach((question, index) => {
              ...
              const questionData = {
                  ...
                  correct_answers: answerKeyData.correctAnswers || [],
                  options: []
              };
          ...
          Swal.fire({
              ...
              html: `
                <div class="text-left">
                  <p>Are you sure you want to create this examination?</p>
              ...
              confirmButtonText: 'Yes, Create Exam!',
...
// Function to save examination to database via AJAX
function saveExaminationToDatabase(examData) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            // Show success message with redirect to REVIEW DASHBOARD
            Swal.fire({
                icon: 'success',
                title: 'Examination Created!',
                html: `
                    <div class="text-left">
                    <p>Your examination has been created successfully!</p>
                    <div class="mt-4 p-3 bg-green-50 rounded border border-green-200">
                        <p><strong>Exam ID:</strong> ${data.exam_id}</p>
                        <p><strong>Status:</strong> <span class="badge badge-warning">Pending Review</span></p>
                    </div>
                    <p class="mt-3 text-sm text-gray-600">You will be redirected to the review dashboard where you can see and manage pending examinations.</p>
                    </div>
                `,
                showConfirmButton: true,
                confirmButtonText: 'Go to Review Dashboard',
                showCancelButton: true,
                ...
                if (result.isConfirmed || result.dismiss === Swal.DismissReason.timer) {
                    // Redirect to review dashboard (not repository)
                    window.location.href = 'review_dashboard.php';
                } else {
                    // User chose to stay, reset the button
                    createExamBtn.classList.remove('btn-loading');
                    createExamBtn.disabled = false;
                }
            });
    ...
    .catch(error => {
      ...
      const stateLoaded = loadFormState();
