...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="container mx-auto px-4 py-8">
          ...
          <div class="mb-12">
            <div class="flex justify-between items-center mb-6">
              <div>
                <h1 class="text-3xl font-bold mb-2">Posted Learning Modules</h1>
                  ...
                  <div class="card bg-base-100 shadow-md module-card" 
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-actions justify-end mt-4">
                        <button class="btn-sm-border" onclick="viewPostedModule(<?php echo $module['id']; ?>)">View</button>
                      </div>
                    </div>
                  </div>
                <?php endforeach; ?>
      ...
      <div class="modal-grid">
        ...
        <div>
          ...
          <div class="action-buttons">
            <button class="action-btn" id="posted-hold-btn">
  ...
  <script>
    ...
    function showPostedModal(moduleData) {
      ...
      document.getElementById('posted-hold-btn').onclick = function() {
      ...
      Swal.fire({
        ...
        preConfirm: () => {
          ...
          return new Promise((resolve) => {
            setTimeout(() => {
              resolve({ success: true, message: 'Module converted successfully!' });
            }, 2000);
          });
        },
        allowOutsideClick: () => !Swal.isLoading()
        ...
        if (result.isConfirmed) {
          Swal.fire({
            ...
            text: 'Module has been converted to quiz successfully!',
            icon: 'success',
            confirmButtonText: 'OK',
            confirmButtonColor: '#3b82f6'
          });
