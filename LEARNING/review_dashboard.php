          ...
          <div class="mb-12" id="modules-section">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
              ...
              <div class="flex gap-4 items-center">
                ...
                <button class="btn btn-border" onclick="window.location.href='learning_module_repository.php'">
              ...
              <?php if (empty($pending_examinations)): ?>
                <div class="col-span-full empty-state">
                  ...
                  <div class="flex gap-2 justify-center">
                    ...
                    <?php endif; ?>
                    <button class="btn-plain px-4 py-2 rounded-lg" onclick="window.location.href='create_examination.php'">
...
<script>
    ...
    function viewExam(examId, title, department, roles, duration, questionCount) {
        ...
        fetch(`fetch_exam_data.php?exam_id=${examId}`)
            .then(response => {
                if (!response.ok) {
                    throw new Error('Network response was not ok');
                }
                ...
                questionsContainer.innerHTML = `
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-red-700">Error loading examination</p>
    ...
    function displayModuleContent(moduleData) {
        ...
        let html = `
            <div class="space-y-3">
                <div>
                    <h5 class="font-semibold text-gray-800 mb-1">${moduleData.title || 'Untitled Module'}</h5>
    ...
    function confirmExamCompliance() {
        ...
        showSweetAlert({
            ...
            if (result.isConfirmed) {
                ...
                updateExamStatus(currentExamId, 'for-compliance', `Examination "${examTitle}" has been marked for compliance.`, requirements);
            } else {
                // Reopen compliance modal if user cancels
                setTimeout(() => {
                    compliance_exam_modal.showModal();
    ...
    // **FIXED: Update exam status function that properly moves exams to repository**
