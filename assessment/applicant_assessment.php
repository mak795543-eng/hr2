    ...
    <div class="flex flex-col flex-1 overflow-auto">
      ...
      <div class="container mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
          ...
          <div>
            <?php if ($exam): ?>
              <a class="btn btn-ghost" href="applicant_assessment.php"><i class="fas fa-arrow-left mr-2"></i>Back</a>
            <?php endif; ?>
          </div>
        </div>
                  ...
                  <?php else: ?>
                    <?php foreach ($postedExams as $e): ?>
                      <tr>
                        ...
                        <td class="text-right">
                          <a class="btn btn-sm btn-primary" href="applicant_assessment.php?exam_id=<?php echo (int)$e['id']; ?>">
                            Take Assessment
                          </a>
                        </td>
                      </tr>
