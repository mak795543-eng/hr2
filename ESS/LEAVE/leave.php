...
$username = "root";
$password = "";
$dbname = "ESS_leave_db"; // Updated database name
            ...
            <main class="flex-1 p-4 md:p-6">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div class="lg:col-span-2">
                  <div class="card bg-white border border-gray-200">
                    <div class="card-body p-4">
                      <h2 class="card-title text-lg font-medium mb-3">📝 My Leave Requests</h2>
                ...
                <div>
                  <div class="card bg-white border border-gray-200">
                    <div class="card-body p-4">
                      <h2 class="card-title text-lg font-medium mb-3">📊 Leave Balance</h2>
                      <div class="space-y-4">
                        ...
                        <div>
                          ...
                          <ul class="text-xs space-y-1">
                            <li>• 15 vacation days per year</li>
                            <li>• 10 sick days per year</li>
                            <li>• 5 emergency days per year</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card bg-white border border-gray-200 mt-4">
                    <div class="card-body p-4">
                      <h2 class="card-title text-lg font-medium mb-3">📌 Request Status</h2>
                      <div class="space-y-2">
                        <?php
                        $pending = 0;
                        $approved = 0;
