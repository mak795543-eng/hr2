        ...
        <div class="flex-1 flex">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center mb-6">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-gray-500">Level: L3 • Dept: Engineering</p>
                            </div>
                        </div>
            ...
            <main class="flex-1 p-4 lg:p-8">
                                ...
                                <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">Daily standup • Tomorrow, 9:30 AM</p>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">Soft skills • Tomorrow, 2:00 PM</p>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">Advanced React • June 25, 11:00 AM</p>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-amber-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">Cloud Architecture • June 26, EOD</p>
                                        </div>
                                    </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start border-l-4 border-green-500 pl-4">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">"Cloud Fundamentals" • Today, 10:30 AM</p>
                                ...
                                <div class="flex items-start border-l-4 border-blue-500 pl-4">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">"Technical Skills Evaluation" • Today, 9:15 AM</p>
                                ...
                                <div class="flex items-start border-l-4 border-amber-500 pl-4">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">"Advanced React Patterns" • Yesterday, 4:20 PM</p>
                                ...
                                <div class="flex items-start border-l-4 border-purple-500 pl-4">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">Moved to "Succession Ready" • June 10</p>
                                ...
                                <div class="flex items-start border-l-4 border-indigo-500 pl-4">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">"Leadership Workshop" • June 9</p>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200 text-center text-sm text-gray-500">
                    <p>© 2023 Talent Development Portal • Employee ID: EMP-2023-045 • Last updated: Today, 11:45 AM</p>
                </div>
            </main>
        </div>
    </div>
