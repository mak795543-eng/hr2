        ...
        <nav class="flex-1 px-2 space-y-1">
            ...
            <?php if (hasAccess('learning_management', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../hr2//training_dev_officer/learning_module_repository.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="library" class="w-4 h-4 text-[#F7B32B]"></i>
                                Learning Module Repository
                            </span>
                        </a>
                        <a href="/../hr2//training_dev_officer/posted_modules.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="upload" class="w-4 h-4 text-[#F7B32B]"></i>
                                Posted Learning Modules
                            </span>
                        </a>
                        <a href="/../hr2//training_dev_officer/examination_repository.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="file-text" class="w-4 h-4 text-[#F7B32B]"></i>
                                Examination Repository
                            </span>
                        </a>
                        <a href="/../hr2//training_dev_officer/posted_examinations.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="clipboard-check" class="w-4 h-4 text-[#F7B32B]"></i>
                                Posted Examinations
                            </span>
                        </a>
                        <a href="/../hr2//training_dev_officer/exam_results.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
            ...
            <?php if (hasAccess('training_management', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../hr2//TRAINING/trainingprogram.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="file-edit" class="w-4 h-4 text-[#F7B32B]"></i>
                                Training Program
                            </span>
                        </a>
                        <a href="/../hr2//TRAINING/posted_trainings.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="send" class="w-4 h-4 text-[#F7B32B]"></i>
                                Posted Trainings
                            </span>
                        </a>
                        <a href="/../hr2//TRAINING/trainingrequest.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="clipboard-list" class="w-4 h-4 text-[#F7B32B]"></i>
                                Training Requests
                            </span>
                        </a>
                        <a href="/../hr2//TRAINING/request_logs.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="send" class="w-4 h-4 text-[#F7B32B]"></i>
            ...
            <?php if (hasAccess('competency_management', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../hr2/CO/criticalgaps/vacancies_request.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="alert-triangle" class="w-4 h-4 text-[#F7B32B]"></i> VACANCY REQUEST </span>
                        </a>

                        <a href="/../hr2/CO/criticalgaps/criticalgaps.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                        ...
                        <a href="/../hr2/CO/criticalgaps/gap_analysis.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                        ...
                        <a href="/../hr2/CO/competecy_criteria.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
            ...
            <?php if (hasAccess('succession_planning', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../hr2/SU/HR_director/succession_dashboard.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="users" class="w-4 h-4 text-[#F7B32B]"></i>
                                Succession Plans
                            </span>
                        </a>
                        <a href="/../hr2/SU/HR_director/requested_idps_repository.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="users" class="w-4 h-4 text-[#F7B32B]"></i>
                                IDP Requests
                            </span>
                        </a>
                        <a href="/../hr2/SU/HR_director/individual_development_plans.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="users" class="w-4 h-4 text-[#F7B32B]"></i>
                                IDP Repository
                            </span>
            ...
            <?php if (hasAccess('approvals', $allowed_modules, $is_supervisor)): ?>
                <div class="px-4 py-2 mt-4">
                    <p class="text-xs font-semibold text-blue-300 uppercase tracking-wider section-title">Approvals
                    </p>
                </div>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../hr2//TRAINING/review.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="check-circle" class="w-4 h-4 text-[#F7B32B]"></i>
                                Training Approvals
                            </span>
                        </a>
                        <a href="/../approval.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="check-circle" class="w-4 h-4 text-[#F7B32B]"></i>
                        ...
                        <a href="/../hr2//hr_manager/review_dashboard.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
            ...
            <?php if (hasAccess('applicant_assessment', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../hr2//applicant/applicant_assessment.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="file-text" class="w-4 h-4 text-[#F7B32B]"></i>
            ...
            <?php if (hasAccess('employee_self_service', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../dashboard.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="layout-dashboard" class="w-4 h-4 text-[#F7B32B]"></i>
                                Dashboard
                            </span>
                        </a>
                        <a href="/../profile_management.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="flag" class="w-4 h-4 text-[#F7B32B]"></i>
                                Profile
                            </span>
                        </a>
                        <a href="/../social_recognition.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="flag" class="w-4 h-4 text-[#F7B32B]"></i>
                                My Achievements
                            </span>
                        </a>
                        <a href="/../paymenthistory.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                        ...
                        <a href="/../mydocuments.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="folder" class="w-4 h-4 text-[#F7B32B]"></i>
                                My Documents
                            </span>
                        </a>
                        <a href="/../submitdocument.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="history" class="w-4 h-4 text-[#F7B32B]"></i>
                                Submit document
                            </span>
                        </a>
                        <a href="/../leaverequest.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="calendar" class="w-4 h-4 text-[#F7B32B]"></i>
                                Leave Request
                            </span>
                        </a>
                        <a href="/../complaint.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="calendar" class="w-4 h-4 text-[#F7B32B]"></i>
                                Complaint
                            </span>
            ...
            <?php if (hasAccess('user_management', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="/../department_accounts.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="users" class="w-4 h-4 text-[#F7B32B]"></i>
                                Department Accounts
                            </span>
                        </a>
                        <a href="/../department_logs.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="list" class="w-4 h-4 text-[#F7B32B]"></i>
                                Department Logs
                            </span>
                        </a>
                        <a href="/../audit_trail&transaction.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
            ...
            <form action="/../logout.php" method="POST" class="px-4 py-3">
