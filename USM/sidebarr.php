        ...
        <nav class="flex-1 px-2 space-y-1">
            ...
            <?php if (hasAccess('training_management', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                  <input type="checkbox" class="peer" />
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="<?php echo $base_url; ?>TRAINING/TRAINING/add_training.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
            ...
            <?php if (hasAccess('competency_management', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        <a href="<?php echo $base_url; ?>COMPETENCY/criticalgaps/vacancies_request.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                                <i data-lucide="alert-triangle" class="w-4 h-4 text-[#F7B32B]"></i> VACANCY REQUEST </span>
                        </a>

                        <a href="<?php echo $base_url; ?>COMPETENCY/criticalgaps/criticalgaps.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                        ...
                        <a href="<?php echo $base_url; ?>COMPETENCY/criticalgaps/gap_analysis.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
