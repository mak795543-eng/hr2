            ...
            <?php if (hasAccess('succession_planning', $allowed_modules, $is_supervisor)): ?>
                ...
                <div class="collapse group">
                    ...
                    <div class="collapse-content pl-14 pr-4 py-1 space-y-1">
                        ...
                        <a href="/../hr2/SUCCESSION/HR_director/development_plans_page.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
                        ...
                        <a href="/../hr2/SUCCESSION/HR_director/pre-promotion_table.php" class="block px-3 py-2 text-sm rounded-lg transition-all hover:bg-blue-600/30 text-blue-100 hover:text-white">
                            <span class="flex items-center gap-2">
